...
#import cv2 
filename = r'D:\Frames\frames-TM1490202529GR00-4\Frames-tm1490202529gr00-4.arf'
...
t0 = time()
dico = MiniBatchDictionaryLearning(n_components=250, alpha=1, n_iter=500)
