...
from funcs import sliding_window2, sifter, pt2blk, hist_matching, AbuSMatrix, cdf
import time 
...
img_ref= arf_obj.load(805) 
    
psnr = my_PSNR.PSNR(img2, new_image) 
print('PSNR=',psnr)    
